...
def identify_smf1(rq,cookies):
    return _identify_forum(r'* l@[1] m@E>"Powered by SMF 1\.[^<]*<" | "t"',None,None,rq,cookies)

def identify_smf2(rq,cookies):
    return _identify_forum(r"""
        * title=E>"Simple Machines( Forum)?" | "t",
        script m@B>"[^a-zA-Z0-9]smf_" | "t"
    """,None,None,rq,cookies)
...
def identify_invision(rq,cookies):
    ...
    """,str.startswith,'ips4_',rq,cookies)
